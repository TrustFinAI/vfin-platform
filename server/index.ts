...
// Fix: Switched from namespace import to default and named imports for Express
// to resolve type conflicts with global DOM types for Request, Response, etc.
...
app.post('/api/stripe-webhook', express.raw({type: 'application/json'}) as unknown as RequestHandler, async (req: Request, res: Response) => {
...
app.post('/api/vcpa/save-profile', verifyToken, async (req: Request, res: Response) => {
